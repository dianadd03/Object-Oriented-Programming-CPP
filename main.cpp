...
int main() {
    ...
    while (window.isOpen()) {
        ...
        if (currentState == AppState::MainMenu) {
            ...
            centerText("Bine ai venit!");
            ImGui::Spacing();
            centerText("Autentifica-te sau creeaza-ti cont pentru a incepe!");
            ImGui::Spacing(); ImGui::Spacing();

            ImVec2 buttonSize = ImVec2(200, 40);

            ImGui::SetCursorPosX((windowWidth - buttonSize.x) / 2);
            if (ImGui::Button("Intra in cont", buttonSize)) {
            ...
            ImGui::SetCursorPosX((windowWidth - buttonSize.x) / 2);
            if (ImGui::Button("Creeaza cont", buttonSize)) {
